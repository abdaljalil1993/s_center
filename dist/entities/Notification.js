...
let Notification = class Notification extends BaseColumns_1.BaseColumns {
};
exports.Notification = Notification;
__decorate([
    (0, typeorm_1.ManyToOne)(() => User_1.User, (user) => user.notifications, { onDelete: 'CASCADE', eager: false }),
