...
panelTeacherRoutes.post('/courses/:id/lectures', validate({ params: teacherCourseIdParamSchema, body: teacherLectureCreateSchema }), asyncHandler(createLectureAction));
panelTeacherRoutes.post('/lectures/:id', validate({ params: teacherLectureIdParamSchema, body: teacherLectureUpdateSchema }), asyncHandler(updateLectureAction));
